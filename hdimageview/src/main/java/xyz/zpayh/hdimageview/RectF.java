 ...
 */
public class RectF implements Sequenceable {
    public float left;
    public float top;
    public float right;
    public float bottom;
     ...
     * @hide
     */
    public void printShortString(@NotNull PrintWriter pw) {
     ...
     *           rectangle.
     */
    public void set(@NotNull RectF src) {
        this.left   = src.left;
        this.top    = src.top;
     ...
     *              rectangle
     */
    public boolean contains(@NotNull RectF r) {
        // check for empty first
        return this.left < this.right && this.top < this.bottom
                // now check for containment
     ...
     *              return false and do not change this rectangle.
     */
    public boolean intersect(@NotNull RectF r) {
     ...
     */
    public boolean setIntersect(@NotNull RectF a, @NotNull RectF b) {
     ...
     */
    public static boolean intersects(@NotNull RectF a, @NotNull RectF b) {
     ...
     */
    public void round(@NotNull Rect dst) {
        dst.set((int)(left + 0.5), (int)(top + 0.5),
                (int)(right + 0.5), (int)(bottom + 0.5));
    }
     ...
     */
    public void roundOut(@NotNull Rect dst) {
     ...
     */
    public void union(@NotNull RectF r) {
...
//    @Override
    ...
    public static final @NotNull Sequenceable.Producer<RectF> CREATOR = new Sequenceable.Producer<RectF>() {
        /**
...
//        @Override
       ...
       public RectF[] createFromParcel(int size) {
